...
const tr: Dictionary = {
  ...
  editorStudio: {
    ...
    structureHint: "Bölümleri, uzunluklarını ve yapı sorunlarını çıkarır.",
    ...
    prepHint: "Temizlik + tipografi: fazla boşluk, boş satır, akıllı tırnak, üç nokta, tire. Her birini ayrı uygulayabilirsiniz.",
...
const en: Dictionary = {
  ...
  editorStudio: {
    ...
    structureHint: "Extracts chapters, their lengths and structural issues.",
    ...
    prepHint: "Cleanup + typography: extra spaces, blank lines, smart quotes, ellipsis, dashes. Apply each one separately.",
